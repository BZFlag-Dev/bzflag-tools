...
git-svn-id: $UPSTREAM_REPO/$LOCATION@$rev $UPSTREAM_UUID"
		...
		EMPTY_COMMIT=`git rev-parse :/@11814.$UPSTREAM_UUID`
		git rebase new_masterban masterban | tr \\r \\n	# loses empty r11814
		git checkout new_masterban
		git merge --ff-only :/@11224.$UPSTREAM_UUID	# r11814 parent
